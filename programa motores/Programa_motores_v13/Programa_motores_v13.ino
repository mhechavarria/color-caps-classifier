    ...
    case EST_VALIDAR_DATOS:
      ...
      if (Serial.available()) 
      {
        ...
        if(c == 'x')
        {
          ...
          for(int i = 0; i < 2; i++)
          {
//            Serial.println("LIMPIO EL BUFFER CIRCUILAR");
//            Serial.println(circularBuffer.Count());
          circularBuffer.ExtractFirst();
//            Serial.println(circularBuffer.First());
          }
...
void mef_sensor_1_antirreb(void)
{
  ...
  switch (estMef_sensor_1)
  {
    ...
    case EST_AREB_DESACTIVADO:
      if(!digitalRead(PIN_ENTRADA_SENSOR1) && (timAreb == 0))
      {        
        //if(habilito_naranja || habilito_gris)
        //{
          habilito_motor1 = 1; //bandera de motor
        //}
        //if(habilito_verde || habilito_amarillo)
        //{
          habilito_motor2 = 1;
        //}
        //if(habilito_azul || habilito_rojo)
        //{ 
          habilito_motor3 = 1;
        //}
        estMef_sensor_1 = EST_AREB_ESPERANDO_ACTIVACION;
