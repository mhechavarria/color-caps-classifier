...
//         Serial.println("habilito_motor1");
//         Serial.println(habilito_motor1);
//         Serial.println("habilito_motor2");
//         Serial.println(habilito_motor2);
//         Serial.println("habilito_motor3");
//         Serial.println(habilito_motor3);
...
//          Serial.println("ESPACIO DISPONIBLE CIRCULARBUFFER");
//          Serial.println(circularBuffer.available());
//          Serial.println("CANTIDAD DE DATOS GUARDADOS");
//          Serial.println(circularBuffer.size());
...
void time_out_banderas(void)
{
  ...
  {
    Serial.println("TIME_OUT_______");
    habilito_gris = 0;
    habilito_verde = 0;
    habilito_rojo = 0;
    habilito_azul = 0;
