...
//CREO UN NUEVO PUERTO SERIE (RX, TX)
...
void sensor1(void)
{
  if(habilito_gris || habilito_naranja || habilito_verde || habilito_amarillo)
  {
    habilito_motor1 = 1;
    habilito_motor2 = 1;
...
void sensor2(void)
{
  if(habilito_rojo || habilito_azul)
  {
    habilito_motor3 = 1;
