...
#define PIN_STEP_M1 5 //en nano es 17
#define PIN_SENTIDO_M1 4  //en nano es 18 
...
#define PIN_STEP_M2 7 //en nano es 5
#define PIN_SENTIDO_M2 6 //en nano es 4
...
#define PIN_STEP_M3 11 //en nano es 7
#define PIN_SENTIDO_M3 10 //en nano es 6
...
{
  static estMef_sensor_enum estMef_sensor = EST_AREB_ESPERANDO_ACTIVACION;  

  switch (estMef_sensor)
  {
    case EST_AREB_ESPERANDO_ACTIVACION:
      if(digitalRead(PIN_ENTRADA_SENSOR1))
      {
        ...
        estMef_sensor = EST_AREB_ACTIVADO;
        Serial.println("EST_AREB_ACTIVADO");
    ...
    case EST_AREB_ACTIVADO:
      ...
      {
        estMef_sensor = EST_AREB_ESPERANDO_DESACTIVACION;
        Serial.println("EST_AREB_ESPERANDO_DESACTIVACION");
      }
      if(!digitalRead(PIN_ENTRADA_SENSOR1))
      {
        estMef_sensor = EST_AREB_ESPERANDO_ACTIVACION;
        Serial.println("EST_AREB_ESPERANDO_ACTIVACION");
      }
    break;
    ...
    case EST_AREB_ESPERANDO_DESACTIVACION:
      ...
      {
        timAreb = tiempoAreb; // configurar macros para 10 segundos
        estMef_sensor = EST_AREB_DESACTIVADO;
        Serial.println("EST_AREB_DESACTIVADO");
      }
    break;
